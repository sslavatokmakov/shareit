...
import ru.tokmakov.shareitserver.item.dto.*;
...
import ru.tokmakov.shareitserver.item.repository.CommentRepository;
import ru.tokmakov.shareitserver.item.repository.ItemRepository;
import ru.tokmakov.shareitserver.user.model.User;
import ru.tokmakov.shareitserver.user.service.UserService;
